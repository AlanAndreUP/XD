...
export default function Chat() {
    ...
    const pacienteChat = JSON.parse(searchParams.get("pacienteChat")); //PASAR ID DE PACIENTE A WEB SOCKET
        ...
        <>
            <main id='chat'>
                <div className="cabeceraChat">
                    <Link href={{
                        pathname: `/Administrador/Pacientes/${pacienteChat.nombre}`,
                        query: { paciente: JSON.stringify(pacienteChat) },
                    }}>
